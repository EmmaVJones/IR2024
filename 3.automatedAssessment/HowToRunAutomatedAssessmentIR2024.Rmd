...
#i = 1
  ...
  stationData <- filter(conventionals, FDT_STA_ID %in% stationTable$STATION_ID[i]) %>%
    #stationData <- filter(conventionals, FDT_STA_ID == '1BCKS003.10') %>% # '1AACO014.57') %>% #"4ACRV006.19") %>% #"1ABIR000.76") %>%# test a specific station
    ...
    #{if('1BCKS003.10' %in% lakeStations$STATION_ID)
