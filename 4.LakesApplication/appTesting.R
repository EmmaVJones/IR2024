...
lakeSelection_ <- regionalAUs %>% 
  ...
  arrange(Lake_Name) %>% 
  pull()
lakeSelection <-  "Smith Mountain Lake" #"Claytor Lake"#"Banister Lake"#"Cherrystone Reservoir"#"Aquia Reservoir (Smith Lake)"# "Claytor Lake"# "Cherrystone Reservoir"#lakeSelection_[7]
