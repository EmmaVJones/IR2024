...
# Retrieve Pins
conventionals <- pin_get('ejones/conventionals2024final', board = 'rsconnect') %>% # This is the DEQ conventionals data
  bind_rows(pin_get("ejones/citmonNonAgencyDataIR2024", board = "rsconnect")) # This is the Non DEQ conventionals data
