shinyUI(fluidPage(theme="yeti.css",
                  navbarPage("VDEQ Benthic Assessment Fact Sheet Tool",
                             tabPanel("About",
                                      ...
                                      HTML("<p>For detailed explanations on how to use the application,
                                           please see the <a href='https://rconnect.deq.virginia.gov/WQAautomatedAssessmentUserManual/bioassessment-applications-how-to.html#bioassessment-applications-how-to' target='_blank'>Automated Assessment User Guide</a></p>")),
                             tabPanel('Assessment Fact Sheet',
                                      sidebarPanel(
                                        helpText("To generate a bioassessment fact sheet, you must first choose an IR window, then choose a station from the list of stations below with
                                                 assessment decisions saved on the R server or upload a spreadsheet of stations with assessment
                                                 decisions."),
                                        uiOutput('userIRwindows_'),
                                        ...
                                        helpText('By uploading data to this application, you are sending assessment decisions on the
                                                 ...
                                                 If you upload a dataset with a station that already exists in the shared dataset, the most recent version will
