...
saveRDS(WQStable, './data/WQStable07262022.RDS')

# clean up workspace
rm(distinctSitesToDoWQS); rm(WQStable); rm(WQStableExisting);rm(WQStableMissing)
```
...
That logic isn't perfect but will work for now
