...
summary(conventionals$FDT_DATE_TIME)
rm(conventionals2022); rm(conventionalsNew)

# add newStations to distinctSites
conventionals2024_distinct <- conventionals %>% 
  distinct(FDT_STA_ID, .keep_all = T) %>% 
  dplyr::select(names(conventionals2022_distinct))
...
```{r}
pin(conventionals2024draft, name = 'conventionals2024draft', description = 'Working IR2024 conventionals dataset, pulled 8/15/2022', board = 'rsconnect')
pin(conventionals2024_distinct,  name = 'conventionals2024_distinctdraft', description = 'Working IR2024 conventionals_distinct dataset, pulled 8/15/2022', board = 'rsconnect')
