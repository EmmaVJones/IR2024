...
rm(basin7); rm(subbasins); rm(subbasins2); rm(cleo)



# almost perfect but issue in 7C and 7D bc they are smashed together and need to be broken out
...
rm(subbasinsNew); rm(x7D);rm(x7C);rm(x7CNew);rm(assessmentLayer); rm(subbasins)
