...
distinctSites1 <- left_join(distinctSites, WQMstations, by = c('FDT_STA_ID' = 'StationID')) %>% 
  ...
  dplyr::select(FDT_STA_ID, STA_DESC, Data_Source, Latitude, Longitude, everything())
...
#saveRDS(distinctSites_sf, './data/distinctSites_sf03062023.RDS')
```
...
Stay tuned for adding in new data from 2021-2022 pulled from the CMC API.
...
#saveRDS(distinctSites_sf, 'data/distinctSites_sf03062023.RDS')#data/distinctSites_sf_withCitmon02232023.RDS')
```
...
distinctSites_sf <- readRDS('./data/distinctSites_sf_withCitmon03062023.RDS') #distinctSites_sf_withCitmon02232023.RDS')
distinctSitesToDo <- distinctSites_sf 
