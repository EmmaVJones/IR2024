...
conventionalsRaw1 <- read_excel('data/draftData/CEDSWQM_2024_IR_20230209.XLSX', sheet = 'CONVENTIONALS') 

conventionalsRaw <- read_excel('data/draftData/CONVENTIONALS_20230216.xlsx', sheet = 'CONVENTIONALS') 
...
#     description = 'Working IR2024 conventionals dataset, EVJ reorganized from Roger 2/17/2023.',
#     board = 'rsconnect')
...
#saveRDS(distinctSites_sf, './data/distinctSites_sf02212023.RDS')
```
