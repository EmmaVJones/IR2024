...
Next steps:
What scale? VAHU5, VAHU6?
Go outside state boundaries?
Pin to server so can be joined in to conventionals dataset by HUC and SampleDate
April 3 (Monday): Need to repull this data (will be provisional) at end of 2022 water year, pin that to server so app/scripts can rerun
