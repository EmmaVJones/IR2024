...
And here is a map of the assessment watersheds (VAHU5 and VAHU6) with all Virginia USGS gages (`USGS sites`), just USGS gages with low flow events in the IR window (`Low Flow USGS sites`). 
...
pin(lowAssessmentFlows, name = 'AssessmentWindowLowFlows', 
    description = 'IR 2024 7Q10 low flow gage information by VAHU5 and VAHU6', 
    board = 'rsconnect')
```
