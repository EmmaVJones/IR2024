...
#already included)
xQy<-function(gageID,#USGS Gage ID
  ...
  if(is.null(dat)){
    warning(paste0("No gage data found for ",gageID))
  }
  ...
  return(list(Flows=list(xQy=out_xQy$xQy,n1Q10=out_1Q10$xQy,n7Q10=out_7Q10$xQy,n30Q10=out_30Q10$xQy,n30Q5=out_30Q5$xQy,HM=HM),
