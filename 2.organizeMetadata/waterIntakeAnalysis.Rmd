...
```{r intake buffer}
VDHintakesBuffer250m <- st_buffer(VDHintakes, dist = 250) %>%
    mutate(bufferWidth = 'Site within 250m VDH Intake Buffer') %>% 
...
sites250m <- st_intersection(conventionals_distinct, VDHintakesBuffer250m)
