                      ...
                      navbarPage(paste("VDEQ ",assessmentCycle," IR Riverine Assessment Tool", sep=''),
                                 ...
                                 tabPanel('Data Upload',
                                          ...
                                          tags$ul(
                                            ...
                                            tags$li("Bioassessment Results- streamlined bioassessment decisions made by regional biologists are imported directly into this
                                                    application where data are available. Contact your regional biologist should you have dataset questions.")),
                                          br(),
